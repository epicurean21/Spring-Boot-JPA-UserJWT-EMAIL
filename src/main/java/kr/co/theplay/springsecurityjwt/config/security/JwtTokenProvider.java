package kr.co.theplay.springsecurityjwt.config.security;
...
public class JwtTokenProvider {
    private String secreteKey = "USwKYibQQTgkW7g-*k.ap9kje-wxBHb9wdXoBT4vnt4P3sJWt-Nu!";

    private long tokenValidTime = 3000 * 60 * 1000L;

    private final UserDetailsService userDetailsService;

    // 객체를 쵝화한다. secreteKey를 Base64로 인코딩
    @PostConstruct
    protected void init() {
    ...
    public String createToken(String userPk, List<String> roles) {
        ...
        return Jwts.builder()
                ...
                .signWith(SignatureAlgorithm.HS256, secreteKey) // 사용할 암호와 알고리즘 + Secrete Key
    ...
    public boolean validateToken(String jwtToken) {
        try {
            Jws<Claims> claims = Jwts.parser().setSigningKey(secreteKey).parseClaimsJws(jwtToken);
